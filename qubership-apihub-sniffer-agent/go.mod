...
require (
	...
	github.com/netcracker/qubership-core-lib-go-paas-mediation-client/v8 v8.3.0
...
require (
	...
	github.com/netcracker/qubership-core-lib-go-bg-state-monitor/v2 v2.3.0 // indirect
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.2.0 // indirect
