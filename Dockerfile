...
COPY qubership-apihub-sniffer-agent ./qubership-apihub-sniffer-agent

WORKDIR /workspace/qubership-apihub-sniffer-agent
...
WORKDIR /app/qubership-apihub-sniffer-agent

COPY --from=builder /workspace/qubership-apihub-sniffer-agent/qubership-apihub-sniffer-agent ./qubership-apihub-sniffer-agent
COPY --from=builder /workspace/qubership-apihub-sniffer-agent/config.yaml ./config.yaml
